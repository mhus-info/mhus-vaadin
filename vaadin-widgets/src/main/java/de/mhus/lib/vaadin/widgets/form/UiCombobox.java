...
public class UiCombobox extends UiVaadin {
	...
	public Component createEditor() {
		...
		ret.setAllowCustomValue(false);
		return ret;
	}

	@Override
	protected void setValue(Object value) throws MException {
		((ComboBox<String>)getComponentEditor()).setValue(MCast.toString(value));
	}

	@Override
	protected Object getValue() throws MException {
		String ret = (String)((ComboBox<String>)getComponentEditor()).getValue();
