...
public class VaadinClientResources implements VaadinResourceProvider {

	public static final String NAME = "com.vaadin.client-compiled";
	...
	public boolean canHandle(String name) {
		if (	
				name.startsWith("/widgetsets/com.vaadin.DefaultWidgetSet")
				)
			return true;
		return false;
	}
