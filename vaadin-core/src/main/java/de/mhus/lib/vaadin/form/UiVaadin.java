...
public abstract class UiVaadin extends UiComponent {
    ...
    public void doRevert() throws MException {
        ...
        if (val == null) val = getConfig().getString("defaultvalue", null);
        ...
        editorEditable =
                getConfig().getBoolean("editable", true)
                        && ds.getBoolean(this, DataSource.EDITOR_EDITABLE, true);
    ...
    public String getCaption(DataSource ds) {
        return MNls.find(
                getForm(),
                ds.getString(
                        this, DataSource.CAPTION, getConfigString(DataSource.CAPTION, getName())));
    }
    ...
    public void setVisible(boolean visible) throws MException {
        ...
        if (componentError != null && componentError.isVisible())
            componentError.setVisible(visible);
    ...
    public void setEditable(boolean editable) throws MException {
        ...
        if (componentEditor != null && editorEditable)
            ((HasValue<?>) componentEditor).setReadOnly(!editable);
    ...
    public void setListeners() {
        ...
        if (e instanceof com.vaadin.v7.ui.AbstractField) {
            ...
            ((com.vaadin.v7.ui.AbstractField<Object>) e)
                    .addValueChangeListener(
                            new com.vaadin.v7.data.Property.ValueChangeListener() {
        ...
        } else if (e instanceof HasValue) {
            //			((AbstractField)e).setImmediate(true);
            ((HasValue<Object>) e)
                    .addValueChangeListener(
                            new ValueChangeListener<Object>() {
        ...
        // focus event
        if (e instanceof com.vaadin.v7.event.FieldEvents.FocusNotifier) {
            ((com.vaadin.v7.event.FieldEvents.FocusNotifier) e)
                    .addFocusListener(
        ...
        } else if (e instanceof FocusNotifier) {
            ((FocusNotifier) e)
                    .addFocusListener(
                            new FieldEvents.FocusListener() {
                                private static final long serialVersionUID = 1L;
