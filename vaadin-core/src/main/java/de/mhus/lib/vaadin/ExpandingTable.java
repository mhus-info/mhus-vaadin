...
/**
 * This type of table is able to expand the datasource. Therefore listen for the render events and
 * expand the table if
 *
 * <pre>
 ...
 * </pre>
 *
 * It's also a need to catch the sort changed event. If you only show a small part of the real data
 * you need to send the sort order to the real data source and reset the data source if the order is
 * changed and maybe jump to the top of the table.
 *
 * @author mikehummel
 */
        ...
        addHeaderClickListener(
                new Table.HeaderClickListener() {
                    ...
                    public void headerClick(HeaderClickEvent event) {
                        ...
                        // update table now
                        if (!MSystem.equals(
                                ExpandingTable.super.getSortContainerPropertyId(), sortedColumn)) {
                        ...
                        if (changed) sortEventHandler.fire();
                    }
                });
    }
