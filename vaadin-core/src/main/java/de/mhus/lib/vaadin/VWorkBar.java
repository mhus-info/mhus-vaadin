...
public abstract class VWorkBar extends HorizontalLayout {
    ...
    public VWorkBar() {
        ...
        menuDelete.addValueChangeListener(
    ...
    protected void doMenuSelected() {
        ...
        if (((String) val[0]).equals("add")) doAdd(val[1]);
        else if (((String) val[0]).equals("mod")) doModify(val[1]);
        else if (((String) val[0]).equals("del")) doDelete(val[1]);
    }
    ...
    protected void doAdd() {
        ...
        for (Pair<String, Object> item : options) {
            Pair<String, Object[]> out =
                    new Pair<String, Object[]>(
                            item.getKey(), new Object[] {"add", item.getValue()});
            menuAdd.addItem(out);
        }
    ...
    protected void doModify() {
        ...
        for (Pair<String, Object> item : options) {
            Pair<String, Object[]> out =
                    new Pair<String, Object[]>(
                            item.getKey(), new Object[] {"mod", item.getValue()});
    ...
    protected void doDelete() {
        ...
        for (Pair<String, Object> item : options) {
            Pair<String, Object[]> out =
                    new Pair<String, Object[]>(
                            item.getKey(), new Object[] {"del", item.getValue()});
