...
public interface GuiSpaceService {
    ...
    /**
     * Return true if the current user have access. Return true if you are unsure. The desktop will
     * have a separate access control.
     *
     * @param control
    ...
    /**
     * This method is called EVERY time the space is shown. It allows the space to create a custom
     * menu. Best practice is to delegate the call into the space object.
     *
     * @param space
     * @param menu
     */
    ...
    /**
     * Return the width of the preview tile. The with could be between 1 and 3. If you are not sure,
     * return 0.
     *
    ...
    /**
     * Creates a new Help Context instance for the given locale or a fallback instance. If the
     * service do not support help. The function should return null.
     *
     * @param locale
