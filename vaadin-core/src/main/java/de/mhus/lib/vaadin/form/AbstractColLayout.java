 ...
 * | 0 | 1 | 2 | 3 | 4 | 5 |
 *
 * <p>50 x 50 | Caption | Field | Wizard | Caption | Field | Wizard | | Caption | Field | Caption |
 * Field | | | Error | | Error |
 *
 * <p>50 x 50 full | Caption | Caption | | Field | Field | | Field | Wizard | Field | Wizard | |
 * Error | Error |
 *
 * <p>100 | Caption | Field | Wizard | | Caption | Field | | | Error |
 *
 * <p>100 full | Caption | | Field | | Field | Wizard | | Error |
 *
 * @author mikehummel
 */
public abstract class AbstractColLayout extends UiLayout {
    ...
    public void createRow(final UiVaadin c) {
        ...
        if (slot == null) {
            ...
            if (c.getConfig().getInt("columns", 1) > (columns - 1)) slot = new UiSlot();
        }
    ...
    public class UiRow {
        ...
        public void setRight(Component component) {
            if (full) return;
            if (wizard) layout.addComponent(component, col + 1, row, col + size - 1, row);
            else layout.addComponent(component, col + 1, row, col + size, row);
        }
        ...
        public void setComponent(Component component) {
            ...
            if (wizard) layout.addComponent(component, 0, row, col + size - 1, row);
            else layout.addComponent(component, 0, row, col + size, row);
        }
