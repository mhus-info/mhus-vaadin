...
public class UiLayout100 extends UiLayout {
    ...
    /**
     * | 0 | 1 | 2 | | Caption | Field | Wizard | | Caption | Field |
     *
     * <p>| | Error |
     *
     * <p>| Caption | | Field | | Field | Wizard | | Error |
     *
     * @author mikehummel
     */
    public class UiRow {
        ...
        public void setRight(Component component) {
            if (full) return;
            if (wizard) layout.addComponent(component, 1, row);
            else layout.addComponent(component, 1, row, 2, row);
        }
        ...
        public void setComponent(Component component) {
            ...
            if (wizard) layout.addComponent(component, 0, row, 1, row);
            else layout.addComponent(component, 0, row, 2, row);
        }
