...
import de.mhus.lib.vaadin.widgets.ui.Border;
...
//		setStyleName(ValoTheme.BUTTON_LINK);
	...
	public void updateCaption() {
		...
		int innerHeight = MCast.toint(getHeight(), -1);
		if (innerHeight > -1) {
			if (margin != null)
		...
		int innerWidth = MCast.toint(getWidth(), -1);
		if (innerWidth > -1) {
			if (margin != null)
		...
		super.getElement().setProperty("innerHTML", c);
	}
